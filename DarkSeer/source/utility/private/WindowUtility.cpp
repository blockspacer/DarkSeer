...
WindowUtil::WindowProxy::WindowProxy()
{
        memset(&m_windowProxyDescriptor, 0, sizeof(m_windowProxyDescriptor));
        m_windowProxyDescriptor.wndProc = WindowUtil::MainWindowProc;
...
WindowUtil::WindowProxy& WindowUtil::WindowProxy::Title(const char* title)
{
        strcpy_s(m_windowProxyDescriptor.WindowTitle, title);
        return *this;
}

WindowUtil::WindowProxy& WindowUtil::WindowProxy::Position(int x, int y)
{
...
WindowUtil::WindowProxy& WindowUtil::WindowProxy::Position(percent<float, float> pos)
{
...
WindowUtil::WindowProxy& WindowUtil::WindowProxy::WindProc(WNDPROC wndProc)
{
        m_windowProxyDescriptor.wndProc = wndProc;
        return *this;
}

WindowUtil::WindowProxy& WindowUtil::WindowProxy::Size(int width, int height)
{
...
WindowUtil::WindowProxy& WindowUtil::WindowProxy::Size(percent<float, float> size)
{
...
WindowUtil::WindowProxy& WindowUtil::WindowProxy::BackgroundColor(unsigned r, unsigned g, unsigned b)
{
...
WindowUtil::CreatedWindow WindowUtil::WindowProxy::Create()
{
        WNDCLASS wc          = {};
