...
inline namespace BitwiseUtility
{
        ...
        // Added an if check to return if n is already CreateWindow power of 2
        ...
        //  gets the next power of 2 that is CreateWindow factor of N which is assumed to be CreateWindow power of 2.
